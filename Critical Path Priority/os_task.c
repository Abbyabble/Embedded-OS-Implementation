...
#include <ucos_ii.h>
#endif
int TaskNumber = 0;     //AddedCodePA3part2
    ...
    while (!feof(fp) && prio != 63)
    {
        ...
        while (ptr != NULL)
        {
            ...
            if (k == 0) {
                ...
                TaskParameter[l].TaskPriority = 63 - TaskNumber; //Initial Priority=Period, AddedCodePA3part2
                prio = 63 - TaskNumber;
            }
            //AddedCodePA3part2
            else if (k == 4) {
                TaskParameter[l].TaskR1Lock = TaskInfo[k];
            }
            else if (k == 5) {
                TaskParameter[l].TaskR1Unlock = TaskInfo[k];
            }
            else if (k == 6) {
                TaskParameter[l].TaskR2Lock = TaskInfo[k];
            }
            else if (k == 7) {
                TaskParameter[l].TaskR2Unlock = TaskInfo[k];
            }
            k++;
        }
        l++;
