                          ...
                          INT8U  *perr)
{
    ...
    pevent->OSEventEnterMutexCnt = 0;                      //AddedCodePA3part2
                   ...
                   INT8U     *perr)
{
    ...
    if (pevent->OSEventEnterMutexCnt == 1)  //AddedCodePA3part2
        return;
    ...
    //AddedCodePA3part2
    if (pevent->OSEventEnterMutexCnt == 0) {
        if ((Output_err = fopen_s(&Output_fp, "./Output.txt", "a")) == 0) {
            if ((OSTimeGet() == (OSTCBCur->OSTCBCyclesStart + OSTCBCur->OSTCBR2Lock - 1)) && OSTCBCur->OSTCBR2Lock != 0) {
            ...
            else if ((OSTimeGet() == (OSTCBCur->OSTCBCyclesStart + OSTCBCur->OSTCBR1Lock - 1)) && OSTCBCur->OSTCBR1Lock != 0) {
                printf("%2d\ttask%d get R1 \t\t\t\t\t\t", OSTimeGet(), OSTCBCur->OSTCBId);
                fprintf(Output_fp, "%2d\ttask%d get R1 \t\t\t\t\t\t", OSTimeGet(), OSTCBCur->OSTCBId);
                OSTCBCur->OSTCBUsingResource++;
            }
        }fclose(Output_fp);
        pevent->OSEventEnterMutexCnt++;
    }
                                                           /* Is Mutex available?                      */
        ...
        if ((Output_err = fopen_s(&Output_fp, "./Output.txt", "a")) == 0) {
            if ((OSTimeGet() == (OSTCBCur->OSTCBCyclesStart + OSTCBCur->OSTCBR2Lock - 1)) && OSTCBCur->OSTCBR2Lock != 0) {
                if (ptcb->OSTCBPrio > pcp) {
                    ...
                    fprintf(Output_fp, " %2d to %d\n", OSTCBCur->OSTCBPrio, pcp);
                }
                else {
                    printf(" %2d to %d\n", OSTCBCur->OSTCBPrio, OSTCBCur->OSTCBPrio);
                    fprintf(Output_fp, " %2d to %d\n", OSTCBCur->OSTCBPrio, OSTCBCur->OSTCBPrio);
                }
            }
            else if ((OSTimeGet() == (OSTCBCur->OSTCBCyclesStart + OSTCBCur->OSTCBR1Lock - 1)) && OSTCBCur->OSTCBR1Lock != 0) {
...
INT8U  OSMutexPost (OS_EVENT *pevent)
{
    ...
    if (pevent->OSEventEnterMutexCnt == 0)  //AddedCodePA3part2
        return;
    ...
    //AddedCodePA3part2
    if (pevent->OSEventEnterMutexCnt == 1) {
        if ((Output_err = fopen_s(&Output_fp, "./Output.txt", "a")) == 0) {
            if ((OSTCBCur->OSTCBCyclesCount + 1 == OSTCBCur->OSTCBR1Unlock) && OSTCBCur->OSTCBR1Unlock != 0) {
                printf("%2d\ttask%d release R1  \t\t\t\t", OSTimeGet() + 1, OSTCBCur->OSTCBId);
                fprintf(Output_fp, "%2d\ttask%d release R1  \t\t\t\t", OSTimeGet() + 1, OSTCBCur->OSTCBId);
                OSTCBCur->OSTCBUsingResource--;
            }
            else if ((OSTCBCur->OSTCBCyclesCount + 1 == OSTCBCur->OSTCBR2Unlock) && OSTCBCur->OSTCBR2Unlock != 0) {
                printf("%2d\ttask%d release R2  \t\t\t\t", OSTimeGet() + 1, OSTCBCur->OSTCBId);
                fprintf(Output_fp, "%2d\ttask%d release R2  \t\t\t\t", OSTimeGet() + 1, OSTCBCur->OSTCBId);
                OSTCBCur->OSTCBUsingResource--;
            }fclose(Output_fp);
        }
        pevent->OSEventEnterMutexCnt--;
