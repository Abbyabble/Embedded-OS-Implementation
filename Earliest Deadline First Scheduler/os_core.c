...
int TotalPrio[5];//AddedCodePA2part1
    ...
    if (OSIntNesting == 0u) {                          /* Schedule only if all ISRs done and ...       */
        if (OSLockNesting == 0u) {                     /* ... scheduler is not locked                  */
            ...
            //if (OSPrioHighRdy != OSPrioCur) {          /* No Ctx Sw if current task is highest rdy     */
                ...
                if ((Output_err = fopen_s(&Output_fp, "./Output.txt", "a")) == 0){
                    if (OSTCBHighRdy->OSTCBPrio == 63) {
                        printf("%2d\tCompletion\t task(%2d)(%2d)    task(%2d)", OSTime, OSTCBCur->OSTCBId, OSTCBCur->OSTCBJobNumber, OSTCBHighRdy->OSTCBPrio);
                        ...
                        fprintf(Output_fp, "%2d\tCompletion\t task(%2d)(%2d)    task(%2d)", OSTime, OSTCBCur->OSTCBId, OSTCBCur->OSTCBJobNumber, OSTCBHighRdy->OSTCBPrio);
                        ...
                        printf("%2d\tCompletion\t task(%2d)(%2d)    task(%2d)(%2d)\t", OSTime, OSTCBCur->OSTCBId, OSTCBCur->OSTCBJobNumber, OSTCBHighRdy->OSTCBId, OSTCBHighRdy->OSTCBJobNumber);
                        printf("      %2d", OSTimeGet() - (OSTCBCur->OSTCBCyclesArrive + OSTCBCur->OSTCBJobNumber * OSTCBCur->OSTCBCyclesPeriod));
                        printf("             %2d", OSTCBCur->OSTCBMyTaskCtxTimes);
                        //printf("             %2d", OSTCBCur->OSTCBCyclesEnd - (OSTCBCur->OSTCBCyclesArrive + OSTCBCur->OSTCBJobNumber * OSTCBCur->OSTCBCyclesPeriod + OSTCBCur->OSTCBCyclesExecution));
                        printf("             %2d", OSTCBCur->OSTCBCyclesEnd - OSTCBCur->OSTCBCyclesStart - OSTCBCur->OSTCBCyclesExecution + 1);//AddedCodePA2part1
                        ...
                        fprintf(Output_fp, "%2d\tCompletion \t task(%2d)(%2d)    task(%2d)(%2d)\t", OSTime, OSTCBCur->OSTCBId, OSTCBCur->OSTCBJobNumber, OSTCBHighRdy->OSTCBId, OSTCBHighRdy->OSTCBJobNumber);
                        fprintf(Output_fp, "      %2d", OSTimeGet() - (OSTCBCur->OSTCBCyclesArrive + OSTCBCur->OSTCBJobNumber * OSTCBCur->OSTCBCyclesPeriod));
                        fprintf(Output_fp, "             %2d", OSTCBCur->OSTCBMyTaskCtxTimes);
                        //fprintf(Output_fp, "             %2d", OSTCBCur->OSTCBCyclesEnd - (OSTCBCur->OSTCBCyclesArrive + OSTCBCur->OSTCBJobNumber * OSTCBCur->OSTCBCyclesPeriod + OSTCBCur->OSTCBCyclesExecution));
                        fprintf(Output_fp, "             %2d", OSTCBCur->OSTCBCyclesEnd - OSTCBCur->OSTCBCyclesStart - OSTCBCur->OSTCBCyclesExecution + 1);//AddedCodePA2part1
                   ...
                   INT16U   opt)
{
    ...
    if (ptcb != (OS_TCB *)0) {
        ...
        //AddedCodePA1part2
        errno_t errr;
        if ((errr = fopen_s(&fp, INPUT_FILE_NAME, "r")) == 0)        /*task set 1-4*/
        {
        ...
        fclose(fp);
        if (prio != 63) {
            unsigned int delay = TaskParameter[id - 1].TaskArriveTime;
            unsigned int exetime = TaskParameter[id - 1].TaskExecutionTime;
            ...
            ptcb->OSTCBCyclesPeriod = TaskParameter[id - 1].TaskPeriodic;
            ptcb->OSTCBCyclesArrive = TaskParameter[id - 1].TaskArriveTime;
            ptcb->OSTCBDeadline = ptcb->OSTCBCyclesArrive + TaskParameter[id - 1].TaskPeriodic;//AddedCodePA2part1
